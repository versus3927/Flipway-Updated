...
class Game(seed: Long = System.nanoTime(), private val upgrades: IntArray = IntArray(3)) {
    ...
    var flipT = 1f
    private var flipY0 = 0f
    var h = 0f
    private var vy = 0f
    var slideT = 0f
    var runPhase = 0f
    var invuln = 0f
    private var stumbleT = 0f
    private var bufJump = 0f
    private var bufSlide = 0f
    var shake = 0f
    var camX = 0f
    private var biomeIdx = 0
    private var _flipT = 1f
    var py0 = 0f
    var py1 = PLAYER_H
