...
class Game(seed: Long = System.nanoTime(), private val upgrades: IntArray = IntArray(3)) {
    ...
    var state: State = State.RUNNING; private set
    var time: Float = 0f; private set
    var deadTime: Float = 0f; private set
    var speed: Float = Config.SPEED_START; private set
    var score: Float = 0f; private set
    var distance: Float = 0f; private set
    var coinsRun: Int = 0; private set
    var wallsFlipped: Int = 0; private set
    var mult: Int = 1; private set
    var continues: Int = 0; private set
